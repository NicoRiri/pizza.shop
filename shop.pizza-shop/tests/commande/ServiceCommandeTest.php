...
class ServiceCommandeTest extends \PHPUnit\Framework\TestCase {
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $dbcom = __DIR__ . '/../../config/shop.db.test.ini';
        ...
        self::$serviceCommande = new \pizzashop\shop\domain\service\commande\sCommande(self::$serviceProduits);
    ...
    private static function fill() {
   	 	...
   	 	// TODO : créer une shop dans la base pour tester l'accès à une shop
    }
